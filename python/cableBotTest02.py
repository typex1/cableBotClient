...
response = requests.post(base_url+'linesURL/2a/0/0/0/0/10/0/185', headers=headers)
#response = requests.post(base_url+'linesURL/3a/81/101/121/0/12/123/185', headers=headers)
#response = requests.post(base_url+'linesURL/4a/82/102/122/0/14/143/185', headers=headers)
